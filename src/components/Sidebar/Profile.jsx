...
const authUser = useAuthStore(state => state.user)
  ...
  return (
    ...
    <ChakraLink display={'flex'} to={`/${authUser?.username}`} as={ReactRouterLink} alignItems={'center'} gap={4} _hover={{bg:'whiteAlpha.400'}} borderRadius={6} p={2} w={{base: 10, md: 'full'}} justifyContent={{base: 'center', md: 'flex-start'}}>
